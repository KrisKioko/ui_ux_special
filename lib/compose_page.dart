...
import 'package:ui_ux_special/model/email_store.dart';
...
class ComposePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (emailStore.currentlySelectedEmailId >= 0) {
      final currentEmail = emailStore.emails[emailStore.currentlySelectedInbox]!.elementAt(emailStore.currentlySelectedEmailId);
...
class _SenderAddressRow extends StatefulWidget {
  ...
  @override
  State<_SenderAddressRow> createState() => _SenderAddressRowState();
}
class _SenderAddressRowState extends State<_SenderAddressRow> {
