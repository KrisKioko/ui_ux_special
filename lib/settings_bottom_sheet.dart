...
extension AnimationSpeedSettingExtension on SlowMotionSpeedSetting {
  double get value {
    switch (this) {
      case SlowMotionSpeedSetting.normal: return 1.0;

      case SlowMotionSpeedSetting.slow: return 5.0;

      case SlowMotionSpeedSetting.slower: return 10.0;

      case SlowMotionSpeedSetting.slowest: return 15.0;
    }
  }
}
...
class SettingsBottomSheetState extends State<SettingsBottomSheet> {
  ...
  void initState() {
    ...
    _slowMotionSpeedSetting = Provider.of<EmailStore>(context, listen: false).slowMotionSpeed;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StatefulBuilder(builder: (context, state) {
      ...
      void setSlowMotionSpeed(SlowMotionSpeedSetting? slowMotionSpeed) {
        ...
        Provider.of<EmailStore>(context, listen: false). slowMotionSpeed = slowMotionSpeed!;
      }
